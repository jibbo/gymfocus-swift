    ...
    var body: some View {
        VStack{
            HStack{
                ...
                Spacer()
                Text(NSLocalizedString("time_in_seconds", comment: "Time in seconds label")).font(.body1).padding()
                Spacer()
            }
            Spacer()
            TextField(NSLocalizedString("seconds", comment: "Seconds placeholder"), text: $text)
                .font(.primaryTitle)
                .focused($isFocused)
                .onAppear {
                ...
                .padding()
            Spacer()
            PrimaryButton(NSLocalizedString("add", comment: "Add button")){
